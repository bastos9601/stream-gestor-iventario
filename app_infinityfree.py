...
# -*- coding: utf-8 -*-
"""
Gestor de Cuentas de Streaming - Aplicación Web para InfinityFree
...
app.config['SECRET_KEY'] = 'tu_clave_secreta_aqui_2024_infinityfree'
# Usar SQLite en memoria para InfinityFree
